...
const AvatarProfile: React.FC = () => {
  ...
  const avatarStats = [
    ...
    { label: 'Missions', value: '127', icon: User },
  ];
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
          ...
          <div className="text-center md:text-left flex-1">
            <h1 className="text-3xl font-bold mb-2 neon-text">ChronoNaut_042</h1>
      ...
      <Tabs defaultValue="appearance" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="glass-card border-accent/20">
              <CardHeader>
                ...
                <CardDescription>Customize your digital appearance</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="aspect-square bg-secondary/20 rounded-lg flex items-center justify-center border-2 border-dashed border-accent/30">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Interactive model loading...</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card border-accent/20">
              <CardHeader>
                ...
                <CardDescription>Modify appearance attributes</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {['Hair Style', 'Facial Features', 'Body Type', 'Clothing', 'Accessories'].map((option, index) => (
                  <div key={index} className="p-4 rounded-lg bg-secondary/20 border border-accent/20">
        ...
        <TabsContent value="stats" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {avatarStats.map((stat, index) => (
              <Card key={index} className="glass-card border-accent/20 text-center">
